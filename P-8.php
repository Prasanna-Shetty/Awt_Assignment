<form action="" enctype="multipart/form-data" method="post">
        ...
        <input type=email name="e1" value="">
        </td></tr>
        <tr><td>
        Address:
        </td>
        ...
        <td>
        <input type=number name="t4" value="">
        </td></tr>
        <tr><td>
        Degree marks(%):
        </td>
        <td>
        <input type=number name="d2" value="">
        </td></tr>
        <tr><td>
        Course studied:
        </td>
        <td>
        <input type=radio name="m1" value="BCA">
        BCA
        </td>
        <td>
        <input type=radio name="m1" value="BSc">
        BSC
        </td>
        <td>
        <input type=radio name="m1" value="B.E">
        B.E
        </td>
        <td>
        <input type=radio name="m1" value="B.Com">
        B.Com
        </td></tr>
        <tr><td>
        Hobbies:
